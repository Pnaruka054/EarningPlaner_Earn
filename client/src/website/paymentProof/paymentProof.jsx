...
const PaymentProof = () => {
    ...
    return (
        <>
            <Helmet>
                <title>EarnWiz Payment Proof</title>
                <meta name="description" content="View verified EarnWiz payment proofs showing successful withdrawals by our users. See real earnings and trust our secure platform." />
            </Helmet>
