...
const GiftCode = ({ setAvailableBalance_forNavBar_state }) => {
    ...
    return (
        <>
            <Helmet>
                <title>EarnWiz GiftCode</title>
                <meta name="description" content="Get daily free gift codes on EarnWiz and boost your earnings effortlessly. Join now for exclusive rewards and unlimited earning opportunities!" />
            </Helmet>
            {data_process_state ? (
