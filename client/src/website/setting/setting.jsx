...
const Setting = ({ setAvailableBalance_forNavBar_state }) => {
    ...
    return (
        <>
            <Helmet>
                <title>EarnWiz Account Settings</title>
                <meta name="description" content="Update your account settings on EarnWiz. On this page, you can securely update your email address and password only." />
            </Helmet>
